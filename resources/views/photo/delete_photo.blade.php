<!-- Delete Modal -->
	<div id='delete_photo{{ $article->id }}' class='modal fade' role='dialog'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<div class='modal-footer'>
					...
					<a href='{{ url("feed/$article->id/delete_photo") }}'><button type'submit' class='btn btn-sm btn-danger' name='delete'>Delete</button></a>
				</div>
			</div>
		</div>
	</div>
