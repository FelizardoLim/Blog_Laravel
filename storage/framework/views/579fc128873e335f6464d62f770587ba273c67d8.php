<!-- Delete Comment Modal -->
	<div id='delete_comment<?php echo e($comment->id); ?>' class='modal fade' role='dialog'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<div class='modal-footer'>
					...
					<a href='<?php echo e(url("feed/{$comment->id}/delete_comment")); ?>'><button type'submit' class='btn btn-sm btn-danger' name='delete'>Delete</button></a>
				</div>
			</div>
		</div>
	</div>
