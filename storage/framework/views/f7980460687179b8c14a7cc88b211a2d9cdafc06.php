<!-- Delete Modal -->
	<div id='delete_article<?php echo e($article->id); ?>' class='modal fade' role='dialog'>
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<div class='modal-footer'>
					...
					<a href='<?php echo e(url("feed/$article->id/delete")); ?>'><button type'submit' class='btn btn-sm btn-danger' name='delete'>Delete</button></a>
				</div>
			</div>
		</div>
	</div>
